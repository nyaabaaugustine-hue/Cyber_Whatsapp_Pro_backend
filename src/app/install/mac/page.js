    ...
    <>
      ...
      <div className="hero">
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <div className="hero-badge">Mac Installation Guide</div>
          <h1>Cyber WhatsApp Pro<br /><span>on your Mac</span></h1>
          <p>Get the extension running in under 2 minutes — no App Store needed</p>
        </div>
      </div>
      ...
      <div className="container">
        <div className="notice">
          ...
          <div className="notice-text">
            <strong>The same extension file works on Mac.</strong> Chrome extensions are cross-platform — no special Mac version is needed. Just follow the steps below to load it into Chrome on your Mac.
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 36 }}>
          {[
            { icon: '🍎', title: 'Mac computer', sub: 'Any macOS version' },
            { icon: '🌐', title: 'Google Chrome', sub: 'Not Safari — must be Chrome' },
        ...
        <div className="steps">
          {[
            { num: '1', title: 'Download the extension file', desc: 'Save the chrome_Extenton.zip file you received to your Mac\'s Downloads folder. If it came via WhatsApp, tap and hold the file → Save to Files → Downloads.' },
            { num: '2', title: 'Unzip the file', desc: 'Find the ZIP in Finder → double-click it. macOS will extract a folder called chrome_Extenton. Move this folder somewhere you won\'t accidentally delete it — for example your Desktop or Documents.', tip: 'Keep this folder on your Mac permanently. If you move or delete it, the extension will stop working.' },
            { num: '3', title: 'Open Chrome Extensions settings', desc: 'Open Google Chrome. In the address bar, type exactly:', path: 'chrome://extensions', descAfter: 'Then press Enter (Return ↵).' },
            ...
            { num: '6', title: 'Select the extension folder', desc: 'A Finder window opens. Navigate to the chrome_Extenton folder you extracted in Step 2. Click once on the folder to select it, then click Select (or Open).', tip: 'Select the folder itself — not the ZIP file and not a file inside the folder.' },
        ...
        <div style={{ background: '#fff', border: '1px solid var(--gray-border)', borderRadius: 'var(--radius)', padding: '20px 22px', marginBottom: 36 }}>
          <div style={{ fontFamily: "'Syne',sans-serif", fontSize: 15, fontWeight: 600, marginBottom: 8 }}>Don't have Google Chrome on your Mac?</div>
          <div style={{ fontSize: 14, color: 'var(--text-mid)', lineHeight: 1.6, marginBottom: 14 }}>Download it free from Google. It works on all Macs including Apple Silicon (M1, M2, M3, M4).</div>
